...
func main(){
	...
	telno := os.Args[1]
	message := os.Args[2]
	fmt.Println("Telefon numarası: ", telno, "\n")
	...
	if err != nil {
		...
		fmt.Println("Mesaj başarıyla gönderilmiştir\n")
		fmt.Println("Mesaj ID : " + msginfo)
	}
	fmt.Println("Konsol 5 saniye sonra kapıtalacaktır.")
	for i := 5; i>0; i-- {
